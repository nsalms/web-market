<template>
  <div class="product-card">
    ...
    <!-- Кнопка удаления -->
    <button @click="deleteProduct(id)" class="product-card__btn_delete">
...
export default {
  ...
  methods: {
    ...mapMutations('main', ['deleteProduct']),
  },
}
</script>
